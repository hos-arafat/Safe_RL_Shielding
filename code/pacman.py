...
def readCommand( argv ):
    ...
    argv = ['-p', 'PacmanQAgent', '-n', '2', '-l', 'smallGrid', '-s', '-g', 'DirectionalGhost']
    argv = ['-p', 'PacmanQAgent', '-n', '2', '-l', 'mediumGrid', '-s', '-g', 'DirectionalGhost']
    argv = ['-p', 'PacmanQAgent', '-n', '2', '-l', 'originalClassic', '-s', '-g', 'DirectionalGhost']
...
def runGames( layout, pacman, ghosts, display, numGames, record, shield, numTraining = 0, catchExceptions=False, timeout=30 ):
    ...
    for i in range( numGames ):
        ...
        print "Type of layout is ", type(layout)
        print "Type of pacman is ", type(pacman)
        print "Type of ghosts is ", type(ghosts)
        print "Type of gameDisplay is ", type(gameDisplay)
